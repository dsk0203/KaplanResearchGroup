...
const config = {
  // REQUIRED
  appName: "Brightverge Research Group",
  // REQUIRED: a short description of your app for SEO tags (can be overwritten)
  appDescription:
    "Brightverge Research Group delivers deep-sector analysis and data-driven solutions to help organizations navigate the complexity of the modern economic landscape.",
  // REQUIRED (no https://, not trailing slash at the end, just the naked domain)
  domainName: "brightverge.com",
  crisp: {
